...
object AniBioMovie {
  ...
  def addingAniBio(yourLAMovieSelection: Int, a: Int): Unit = {
  ...
  //LADramaMovies
  def AniBioMovies(ahhh: Int): Unit = {
    val url = "jdbc:mysql://localhost:3306/project0"
    val username = "root"
    val password = "KafeAde!f1a"
    val connection = DriverManager.getConnection(url, username, password)
    ...
    moreOfAAniBioMovie(ahhh)
  }

  //LADramaMovies But You Aren't Stuck:
  def AniBioMoviesButNotStuck(huh: Int): Unit = {
    val url = "jdbc:mysql://localhost:3306/project0"
    val username = "root"
    val password = "KafeAde!f1a"
    val connection = DriverManager.getConnection(url, username, password)
